...
export const metadata: Metadata = {
  title: "F1 Motorsport | Championship Racing Vehicles",
  description: "Discover next-generation Formula 1 cars engineered for speed and performance. Experience championship-level racing technology.",
  keywords: "Formula 1, racing vehicles, F1 cars, motorsport, championship",
  metadataBase: new URL("https://f1motorsport.com"),
  alternates: {
    canonical: "https://f1motorsport.com"
  },
  robots: {
    index: true,
    follow: true
  ...
  openGraph: {
    title: "F1 Motorsport | Championship Racing Vehicles",
    description: "Discover next-generation Formula 1 cars engineered for speed and performance.",
    type: "website",
    siteName: "F1 Motorsport",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1764591151339-t6egy13k.jpg",
      alt: "F1 racing vehicle"
    }]
  },
  twitter: {
    ...
    title: "F1 Motorsport | Championship Racing Vehicles",
    description: "Discover next-generation Formula 1 cars engineered for speed and performance.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1764591151339-t6egy13k.jpg"]
  }
};
